  ...
  render() {
    return (
      <div style={btnFlexbox}>
        <div style={btnBlue}>
          <ButtonGroup>
            <Button href="/" startIcon={<HomeSharpIcon />} style={blueButton} />
            <Button startIcon={<FilterHdrSharpIcon />} style={blueButton} />
            <Button startIcon={<BeachAccessSharpIcon />} style={blueButton} />

            <Button
              startIcon={<AccountBalanceSharpIcon />}
              style={blueButton}
            />
            <Button
              target="_blank"
        ...
        <div style={btnWhite}>
          <ButtonGroup>
            <Button
              onClick={() =>
                this.context.pokemonData
                  ? console.log("Nothing happend")
                  : this.context.pokemonFuncs.setRegion(+1)
              }
